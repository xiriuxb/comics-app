    ...
    <nav className="h-10">
      <div className="flex bg-tomato h-full px-2">
        <ul className="flex flex-1 h-full items-center">
          <li>
            <InertiaLink className="hover:bg-slate-600/30 p-2" href="/">
              Inicio
            </InertiaLink>
          </li>
          <li>
            <InertiaLink className="hover:bg-slate-600/30 p-2" href="/comics">
              Comics
            </InertiaLink>
          </li>
          <li>
        ...
        <ul className="flex h-full items-center">
          <li>
            <InertiaLink className="hover:bg-slate-600/30 p-2" href="/login">
              Login
            </InertiaLink>
          </li>
          <li>
